...
class GUI_EXPORT QgsGeoImageAnnotationItem: public QgsAnnotationItem
{
  ...
  public:
    static QgsGeoImageAnnotationItem* create( QgsMapCanvas* canvas, const QString& filePath, bool onlyGeoreferenced, QString *errMsg = 0 );
    ...
    void setFilePath( const QString& filePath , bool originalSize = false );
