...
class CORE_EXPORT QgsRedliningLayer : public QgsVectorLayer
{
    Q_OBJECT
  public:
    QgsRedliningLayer( const QString& name );
    ...
    bool addText( const QString &text, const QgsPointV2 &pos, const QColor& color, const QFont& font , const QString &tooltip = QString() );
