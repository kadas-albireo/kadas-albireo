...
class CORE_EXPORT QgsRedliningLayer : public QgsVectorLayer
{
  ...
  public:
    ...
    bool addShape( QgsGeometry* geometry, const QColor& outline, const QColor& fill, int outlineSize, Qt::PenStyle outlineStyle, Qt::BrushStyle fillStyle , const QString &flags = QString() , const QString &tooltip = QString(), const QString& text = QString() , const QString &attributes = QString() );
    ...
    QgsFeatureList pasteFeatures( const QgsFeatureStore &featureStore , QgsPoint *targetPos = 0 );
